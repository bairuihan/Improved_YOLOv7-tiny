...
from models.common import MobileViTBv3

from models.biform import BiFormerBlock
...
class Model(nn.Module):
    ...
    def forward_once(self, x, profile=False):
        ...
        for m in self.model:
            ...
            if self.traced:
                if isinstance(m, Detect) or isinstance(m, IDetect) or isinstance(m, TDetect) or isinstance(m, IKeypoint):
                    break

            if profile:
                c = isinstance(m, (Detect, IDetect, TDetect, IBin))
...
def parse_model(d, ch):  # model_dict, input_channels(3)
    ...
    for i, (f, n, m, args) in enumerate(d['backbone'] + d['head']):  # from, number, module, args
        ...
        if m in [nn.Conv2d, Conv, RobustConv, RobustConv2, DWConv, GhostConv, RepConv, RepConv_OREPA, DownC, 
                 ...
                 SwinTransformer2Block, ST2CSPA, ST2CSPB, ST2CSPC, C3,FasterNeXt,Conv2Formers,ACmix,MobileViTBv3,SPPFCSPC,PConv]:
            c1, c2 = ch[f], args[0]
